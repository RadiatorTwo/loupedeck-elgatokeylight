namespace Loupedeck.ElgatoKeyLightPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.ElgatoKeyLightPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.ElgatoKeyLightPlugin.Resources.Resource.txt`.
        public static String[] GetFilesInFolder(String folderName)
        {
            return PluginResources._assembly.GetFilesInFolder(folderName);
        }
        ...
        {
            return PluginResources._assembly.FindFileOrThrow(fileName);
        }
        ...
        {
            return PluginResources._assembly.FindFiles(regexPattern);
        }
        ...
        {
            return PluginResources._assembly.GetStream(PluginResources.FindFile(resourceName));
        }
        ...
        {
            return PluginResources._assembly.ReadTextFile(PluginResources.FindFile(resourceName));
        }
        ...
        {
            return PluginResources._assembly.ReadBinaryFile(PluginResources.FindFile(resourceName));
        }
        ...
        {
            return PluginResources._assembly.ReadImage(PluginResources.FindFile(resourceName));
        }
